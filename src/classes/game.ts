...
export default class Game implements IGame {
	...
	public handleFallTimer = (): PlayerResultEnum[] =>
		this.handleBoardResponse(this.board.movePlayer(DirectionEnum.FALL_DOWN));
	public handleJumpTimer = (): PlayerResultEnum[] =>
		this.handleBoardResponse(this.board.movePlayer(DirectionEnum.JUMP));
